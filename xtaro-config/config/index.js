...
const config = {
  ...
  }], "@ctrip/xtaro-plugin-platform-crn", "@ctrip/xtaro-plugin-platform-nfes"],
  defineConstants: {},
  ...
  h5: {
    ...
    router: {
      ...
      customRoutes: {
        ...
        "pages/xtaro-config/index": "/xtaro-config",
        "pages/xtaro-config/subPackages/foo/index": "/xtaro-config/subPackages/foo",
        "pages/xtaro-config/subPackages/bar/index": "/xtaro-config/subPackages/bar"
      }
    },
    // watch 时使用的 port
    devServer: {
